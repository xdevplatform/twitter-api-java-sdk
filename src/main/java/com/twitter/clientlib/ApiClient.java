...
public class ApiClient {
    ...
    public void setTwitterCredentials(TwitterCredentialsOAuth1 credentials) {
        ...
        if(!StringUtils.isEmpty(credentials.getTwitterConsumerKey()) && !StringUtils.isEmpty(credentials.getTwitterToken())) {
            TwitterApiKeyOAuth userToken = (TwitterApiKeyOAuth) getAuthentication("UserToken");
    ...
    public String[] reduceAuthNames(String[] localVarAuthNames) {
        ...
        if(localVarAuthNames.length > 1) {
            ...
            } else if (Arrays.asList(localVarAuthNames).contains("UserToken")) {
                authName = "UserToken";
            } else {
    ...
    private void init() {
        ...
        setUserAgent("twitter-api-java-sdk/1.1.0");
