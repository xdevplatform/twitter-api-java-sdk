...
public class AddBookmarkRequest {
  ...
  public AddBookmarkRequest tweetId(String tweetId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tweetId, addBookmarkRequest.tweetId);
  }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddBookmarkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddBookmarkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddBookmarkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddBookmarkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddBookmarkRequest>() {
           @Override
           public void write(JsonWriter out, AddBookmarkRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddBookmarkRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AddBookmarkRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddBookmarkRequest
  * @throws IOException if the JSON string is invalid with respect to AddBookmarkRequest
  */
  public static AddBookmarkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddBookmarkRequest.class);
  }

 /**
  * Convert an instance of AddBookmarkRequest to an JSON string
  *
  * @return JSON string
  */
