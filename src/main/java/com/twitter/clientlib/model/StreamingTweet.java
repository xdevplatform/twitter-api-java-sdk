...
public class StreamingTweet {
  ...
  public StreamingTweet data(Tweet data) {
  ...
  **/
  ...
  public StreamingTweet includes(Expansions includes) {
  ...
  **/
  ...
  public StreamingTweet errors(List<Problem> errors) {
    
    this.errors = errors;
    return this;
  }

  public StreamingTweet addErrorsItem(Problem errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StreamingTweet streamingTweet = (StreamingTweet) o;
    return Objects.equals(this.data, streamingTweet.data) &&
        Objects.equals(this.includes, streamingTweet.includes) &&
        Objects.equals(this.errors, streamingTweet.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamingTweet {\n");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (StreamingTweet.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has reuqired fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in StreamingTweet is not found in the empty JSON string", StreamingTweet.openapiRequiredFields.toString()));
        }
      }
      Set<Entry<String, JsonElement>> entries = jsonObj.entrySet();
      // check to see if the JSON string contains additional fields
      for (Entry<String, JsonElement> entry : entries) {
        if (!StreamingTweet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StreamingTweet` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<StreamingTweet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StreamingTweet.class));
